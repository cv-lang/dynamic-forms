...
namespace Cvl.DynamicForms.Tools.Extension
{
    /// <summary>
    ...
    public static class ObjectExtensions
    {
        public static string GetPropertyDescription(this PropertyInfo pi)
        {
            ...
            var art3 = pi.GetCustomAttributes(typeof(DisplayAttribute));
            foreach (DisplayAttribute a in art3)
            {
                str.Append(a.Description);
            }
        ...
        public static int GetPropertyOrder(this PropertyInfo pi)
        {
            ...
            var art3 = (DisplayAttribute)pi.GetCustomAttribute(typeof(DisplayAttribute));
            if (art3 != null)
            {
                return art3.Order;
            }
        ...
        public static DisplayAttribute GetDataFormAttribute(this PropertyInfo pi)
        {
